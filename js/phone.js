...
function logIn() {
    ...
    document.getElementsByClassName("multiply")[0].style.display = "none"
    document.getElementsByClassName("dot")[0].style.display = "none"
    document.getElementById("null").style.display = "none"
    document.getElementById("plussminus").style.display = "none"
    document.getElementById("prosent").style.display = "none"
...
function calculator() {
    ...
    document.getElementsByClassName("pluss")[0].style.display = "block"
    document.getElementsByClassName("minus")[0].style.display = "block"
    document.getElementsByClassName("multiply")[0].style.display = "block"
    ...
    document.getElementsByClassName("operators")[0].style.display = "block"
    document.getElementsByClassName("numbers")[0].style.display = "block"
    document.getElementsByClassName("equal")[0].style.display = "block"
